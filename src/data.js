...
export const searchNavItems = [
  {
    id: 1,
    normalText: "Location",
    boldText: "Explore nearby Matches",
    icon: navLocationIcon,
  },
  {
    id: 2,
    normalText: "Profiles",
    boldText: "Updated Profiles",
    icon: navBikeIcon,
  },
  {
    id: 3,
    normalText: "Horoscope",
    boldText: "Match With Horoscope",
    icon: navCalendarIcon,
  },
  {
    id: 4,
    normalText: "Members",
    boldText: "Genuine Members",
    icon: navGroupIcon,
  },
];
...
export const footerNav = [
  ...
  },
  {
    id: 2,
    title: "Connect",
    links: ["Partner With Us", "FAQ", "Blog"],
  },
  {
    id: 3,
    title: "Support",
